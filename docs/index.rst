.. Wagtail Bifrost's documentation master file, created by
   sphinx-quickstart on Tue May 21 19:46:16 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Wagtail Bifrost's documentation!
===========================================
...
The purpose of Bifrost is to be able to build GraphQL endpoints on a model 
